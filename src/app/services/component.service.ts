...
export class ComponentService {
  ...
  private component$: ComponentModel[] = [
      ...
      new CPUModel(11,"AMD","5 2600","YD2600BBAFBOX",this.rivenditori$[1],140,"3.4 GHz",100,1550,"AM4"),
      new CPUModel(12,"Intel","i7 6900k","RGB600BOX",this.rivenditori$[1],255,"4.0 Ghz",100,3000,"AM4"),
];
  constructor() { }
